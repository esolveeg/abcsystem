...
type Querier interface {
	...
	PageFindForUpdate(ctx context.Context, arg PageFindForUpdateParams) (TenantsSchemaPage, error)
	...
	PartialFindForUpdate(ctx context.Context, arg PartialFindForUpdateParams) (TenantsSchemaPartial, error)
	PartialList(ctx context.Context, tenantID int32) ([]TenantsSchemaPartial, error)
	PartialTypeListInput(ctx context.Context) ([]PartialTypeListInputRow, error)
	...
	SectionFind(ctx context.Context, arg SectionFindParams) (TenantsSchemaSection, error)
	SectionList(ctx context.Context, tenantID int32) ([]TenantsSchemaSection, error)
	SectionListInpt(ctx context.Context) ([]SectionListInptRow, error)
