...
exports.createProtobufSafeUpdater = exports.isAbortController = void 0;
 ...
 */
const createProtobufSafeUpdater = (schema, updater) => (prev) => {
    if (typeof updater !== "function") {
        if (updater === undefined) {
            return undefined;
        }
        if ((0, protobuf_1.isMessage)(updater, schema.output)) {
            return updater;
        }
        return (0, protobuf_1.create)(schema.output, updater);
    }
    return updater(prev);
};
