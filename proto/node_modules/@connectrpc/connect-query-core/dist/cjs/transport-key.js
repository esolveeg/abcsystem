...
exports.createTransportKey = createTransportKey;
exports.addStaticKeyToTransport = addStaticKeyToTransport;
const staticKeySymbol = Symbol("static-key");
const transportKeys = new WeakMap();
let counter = 0;
/**
 ...
 */
function addStaticKeyToTransport(transport, key) {
    return { ...transport, [staticKeySymbol]: key };
}
//# sourceMappingURL=transport-key.js.map