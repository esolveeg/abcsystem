...
exports.createMessageKey = createMessageKey;
 ...
 */
function createMessageKey(schema, value, pageParamKey) {
    // eslint-disable-next-line @typescript-eslint/no-use-before-define -- circular reference
    return messageKey((0, reflect_1.reflect)(schema, (0, protobuf_1.create)(schema, value)), pageParamKey?.toString());
}
function scalarKey(value) {
    ...
    if (value instanceof Uint8Array) {
        return (0, wire_1.base64Encode)(value, "std_raw");
    }
    return value;
}
