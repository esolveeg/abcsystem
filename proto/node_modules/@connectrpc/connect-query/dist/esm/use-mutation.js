 ...
 */
export function useMutation(schema, { transport, ...queryOptions } = {}) {
    const transportFromCtx = useTransport();
    const transportToUse = transport ?? transportFromCtx;
    const mutationFn = useCallback(async (input) => callUnaryMethod(transportToUse, schema, input), [transportToUse, schema]);
