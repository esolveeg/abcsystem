 ...
 */
function useInfiniteQuery(schema, input, { transport, pageParamKey, getNextPageParam, ...queryOptions }) {
    const transportFromCtx = (0, use_transport_js_1.useTransport)();
    const baseOptions = (0, connect_query_core_1.createInfiniteQueryOptions)(schema, input, {
 ...
 */
function useSuspenseInfiniteQuery(schema, input, { transport, pageParamKey, getNextPageParam, ...queryOptions }) {
    const transportFromCtx = (0, use_transport_js_1.useTransport)();
    const baseOptions = (0, connect_query_core_1.createInfiniteQueryOptions)(schema, input, {
        transport: transport ?? transportFromCtx,
        getNextPageParam,
...
//# sourceMappingURL=use-infinite-query.js.map