...
import (
	...
	companyUsecase "github.com/darwishdev/devkit-api/app/company/usecase"
...
type Api struct {
	...
	companyUsecase  companyUsecase.CompanyUsecaseInterface
	// USECASE_FIELDS
...
func NewApi(config config.Config, store db.Store, tokenMaker auth.Maker, redisClient redisclient.RedisClientInterface, validator *protovalidate.Validator) (devkitv1connect.DevkitServiceHandler, error) {
	...
	companyUsecase := companyUsecase.NewCompanyUsecase(store)
