...
select 
  u.user_id,
  u.user_name,
  is_null_replace(u.user_image , '')::varchar(200) user_image,
  u.user_email,
  is_null_replace(u.user_phone , '')::varchar(200) user_phone,
  ut.user_type_id,
  ut.user_type_name,
  accounts_schema.user_security_level_find(u.user_id)::int user_security_level,
  is_null_replace(t.tenant_id , 0)::int tenant_id,
  is_null_replace(t.tenant_name , '')::varchar(200) tenant_name,
  u.created_at,
  u.updated_at,
  u.deleted_at,
  (
