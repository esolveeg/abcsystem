...
CREATE TABLE properties_schema.location (
	...
	location_name_ar varchar(200) UNIQUE NOT NULL,
...
CREATE TABLE properties_schema.property (
	...
	address_line_ar varchar(200) NOT NULL,
	...
	FOREIGN KEY (owner_id) REFERENCES accounts_schema.user (user_id),
	property_image text,
...
CREATE TABLE properties_schema.reservable_unit (
	...
	reservable_unit_name_ar varchar(200) NOT NULL UNIQUE,
